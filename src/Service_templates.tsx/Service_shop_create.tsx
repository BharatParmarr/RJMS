...
const Service_shop_create = ({ hostel }: any) => {
    ...
    const handleSubmit = (e: any) => {
        ...
        if (hostel) {
            api.put(`/`, newFormData).then(onSave);
        } else {
            api.post('/', newFormData).then(onSave);
        }
    };
    ...
    const onSave = (response: any) => {
        ...
        window.location.href = '/service-shop'
    };
...
export default Service_shop_create;
